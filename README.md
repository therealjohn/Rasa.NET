...
There are a few required tools and steps to get everything setup before you can run the game. Follow the steps in the [setup guide](docs/setup.md). Creature pathfinding needs per-map navmeshes built from the client data; see [docs/navmesh.md](docs/navmesh.md).
