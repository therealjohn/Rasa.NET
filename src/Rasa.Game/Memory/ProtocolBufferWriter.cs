...
namespace Rasa.Memory
{
    public class ProtocolBufferWriter : IDisposable
    {
        ...
        public void WriteMovementData(Movement movement)
        {
            WriteDebugByte(41);
            ...
            WriteViewCoords(movement.ViewDirection);
        ...
        public void WriteViewCoords(Vector2 viewDirection)
        {
            WriteDebugByte(41);

            WriteUShort((ushort)(viewDirection.X * 10430.378f));
            WriteUShort((ushort)(viewDirection.Y * 10430.378f));
