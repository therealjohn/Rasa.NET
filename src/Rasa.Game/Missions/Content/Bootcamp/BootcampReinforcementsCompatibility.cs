...
namespace Rasa.Game.Missions.Content.Bootcamp
{
    ...
    internal static class BootcampReinforcementsCompatibility
    {
        ...
        internal static void NormalizeDurable(uint characterId, ICharUnitOfWork unit, MissionApplication manager)
        {
            ...
            if (mission == null || !MissionApplication.IsPublishedState((MissionState)mission.MissionState) ||
        ...
        internal static void NormalizeProgress(
            Manifestation player, IGameUnitOfWorkFactory factory, MissionApplication manager, MissionProgressEvent progress)
        {
        ...
        internal static void NormalizeRuntime(
            Manifestation player, IGameUnitOfWorkFactory factory, MissionApplication manager, uint? requestedMissionId = null)
        {
