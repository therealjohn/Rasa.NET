namespace Rasa.Packets.Minion.Client
{
    ...
    /// <summary>
    /// <c>MinionAssistTarget</c>, which sends <c>(targetId,)</c> - the entity the player had under
    ...
    /// </summary>
    public class MinionAssistTargetPacket : ClientPythonPacket
    {
        public override GameOpcode Opcode { get; } = GameOpcode.MinionAssistTarget;
