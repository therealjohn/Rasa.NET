...
namespace Rasa.Test.World
{
    ...
    public class DepartureFailureTests
    {
        ...
        [DataRow(17)]
        [DataRow(500)]
        public void ClanCleanupToleratesTheActualInitializedInventoryLength(int count)
        {
            ...
            Assert.AreEqual(count, client.Player.Inventory.ClanInventory.Count);
        ...
        public void FailedRosterRefreshDoesNotPreventMandatoryDisconnectCleanup()
        {
            ...
            {
                ["GetAllClanMembersByClanId"] = new SqliteException("Fixture roster query failure.", 1)
            });
            ...
            try
            {
                ...
                Assert.IsTrue(((StrictProxy)(object)repository).Calls.Contains("GetAllClanMembersByClanId"));
