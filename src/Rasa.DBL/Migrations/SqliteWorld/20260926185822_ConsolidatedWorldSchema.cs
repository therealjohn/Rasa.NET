    ...
    public partial class ConsolidatedWorldSchema : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    marker_entity_id = table.Column<ulong>(type: "INTEGER", nullable: false),
                    map_context_id = table.Column<uint>(type: "INTEGER", nullable: false),
                    marker_type = table.Column<uint>(type: "INTEGER", nullable: false),
                    object_kind = table.Column<byte>(type: "INTEGER", nullable: false),
                    object_id = table.Column<uint>(type: "INTEGER", nullable: false),
                    match_distance = table.Column<double>(type: "REAL", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    abandonment_policy = table.Column<byte>(type: "tinyint(3)", nullable: false),
                    client_name_text_id = table.Column<uint>(type: "int(11)", nullable: false),
                    giver_id = table.Column<uint>(type: "int(11)", nullable: true),
                    receiver_id = table.Column<uint>(type: "int(11)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<uint>(type: "integer", nullable: false),
                    class_id = table.Column<uint>(type: "INTEGER", nullable: false),
                    required_level = table.Column<uint>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    client_counter_0_text_id = table.Column<uint>(type: "int(11)", nullable: true),
                    client_counter_1_text_id = table.Column<uint>(type: "int(11)", nullable: true),
                    client_counter_2_text_id = table.Column<uint>(type: "int(11)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    selection_count = table.Column<byte>(type: "tinyint(3)", nullable: false),
                    comment = table.Column<string>(type: "varchar(64)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    requirement = table.Column<byte>(type: "tinyint(3)", nullable: false),
                    start_policy = table.Column<byte>(type: "tinyint(3)", nullable: false, defaultValue: (byte)1),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    comment = table.Column<string>(type: "varchar(64)", nullable: false),
                    spawn_policy = table.Column<byte>(type: "tinyint(3)", nullable: false, defaultValue: (byte)0)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_mission_spawn_group", x => new { x.mission_id, x.content_revision, x.spawn_group_id });
                    table.ForeignKey(
                        name: "FK_mission_spawn_group_mission_area_mission_id_content_revision_area_id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    comment = table.Column<string>(type: "varchar(64)", nullable: false),
                    item_intent = table.Column<string>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_mission_action_mission_indicator_mission_id_content_revision_objective_id_indicator_id",
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_mission_action_mission_objective_definition_mission_id_content_revision_target_objective_id",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_mission_action_mission_reward_definition_mission_id_content_revision_reward_id",
                        columns: x => new { x.mission_id, x.content_revision, x.reward_id },
                        principalTable: "mission_reward_definition",
                        principalColumns: new[] { "mission_id", "content_revision", "reward_id" },
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_mission_action_mission_scenario_mission_id_content_revision_scenario_id",
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_mission_action_mission_spawn_group_mission_id_content_revision_spawn_group_id",
                        columns: x => new { x.mission_id, x.content_revision, x.spawn_group_id },
                        principalTable: "mission_spawn_group",
                        principalColumns: new[] { "mission_id", "content_revision", "spawn_group_id" },
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_mission_trigger_mission_area_mission_id_content_revision_area_id",
                        columns: x => new { x.mission_id, x.content_revision, x.area_id },
                        principalTable: "mission_area",
                        principalColumns: new[] { "mission_id", "content_revision", "area_id" },
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_mission_trigger_mission_objective_definition_mission_id_content_revision_related_objective_id",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    reward_id = table.Column<uint>(type: "int(11)", nullable: true),
                    spawn_group_id = table.Column<uint>(type: "int(11)", nullable: true),
                    spawn_id = table.Column<uint>(type: "int(11)", nullable: true),
                    dynamic_object_key = table.Column<string>(type: "varchar(64)", maxLength: 64, nullable: true),
                    entity_class_id = table.Column<uint>(type: "int(11)", nullable: true),
                    target_scenario_id = table.Column<uint>(type: "int(11)", nullable: true),
                    delay_milliseconds = table.Column<uint>(type: "int(11)", nullable: true),
                    skill_id = table.Column<uint>(type: "int(11)", nullable: true),
                    ability_id = table.Column<uint>(type: "int(11)", nullable: true),
                    skill_level = table.Column<byte>(type: "tinyint(3)", nullable: true),
                    ability_slot = table.Column<byte>(type: "tinyint(3)", nullable: true),
                    tutorial_id = table.Column<uint>(type: "int(11)", nullable: true),
                    audio_set_id = table.Column<uint>(type: "int(11)", nullable: true),
                    attempt_key = table.Column<string>(type: "varchar(64)", nullable: true),
                    scenario_event_id = table.Column<uint>(type: "int(11)", nullable: true),
                    map_context_id = table.Column<uint>(type: "int(11)", nullable: true),
                    pos_x = table.Column<double>(type: "REAL", nullable: true),
                    pos_y = table.Column<double>(type: "REAL", nullable: true),
                    pos_z = table.Column<double>(type: "REAL", nullable: true),
                    orientation = table.Column<double>(type: "REAL", nullable: true),
                    initial_interaction_enabled = table.Column<bool>(type: "bit", nullable: true),
                    qualification_key = table.Column<byte>(type: "tinyint(3)", nullable: true),
                    qualification_value = table.Column<byte>(type: "tinyint(3)", nullable: true),
                    account_skip_entitlement = table.Column<bool>(type: "bit", nullable: true),
                    comment = table.Column<string>(type: "varchar(64)", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_mission_scenario_step_mission_objective_definition_mission_id_content_revision_target_objective_id",
                        columns: x => new { x.mission_id, x.content_revision, x.target_objective_id },
                        principalTable: "mission_objective_definition",
                        principalColumns: new[] { "mission_id", "content_revision", "objective_id" },
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_mission_scenario_step_mission_reward_definition_mission_id_content_revision_reward_id",
                        columns: x => new { x.mission_id, x.content_revision, x.reward_id },
                        principalTable: "mission_reward_definition",
                        principalColumns: new[] { "mission_id", "content_revision", "reward_id" },
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_mission_scenario_step_mission_scenario_mission_id_content_revision_target_scenario_id",
                        columns: x => new { x.mission_id, x.content_revision, x.target_scenario_id },
                        principalTable: "mission_scenario",
                        principalColumns: new[] { "mission_id", "content_revision", "scenario_id" },
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_mission_scenario_step_mission_spawn_group_mission_id_content_revision_spawn_group_id",
                        columns: x => new { x.mission_id, x.content_revision, x.spawn_group_id },
                        principalTable: "mission_spawn_group",
                        principalColumns: new[] { "mission_id", "content_revision", "spawn_group_id" },
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_mission_scenario_step_mission_spawn_mission_id_content_revision_spawn_group_id_spawn_id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_mission_action_mission_id_content_revision_objective_id_indicator_id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_mission_action_mission_id_content_revision_target_objective_id",
                table: "mission_action",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_mission_scenario_step_mission_id_content_revision_spawn_group_id_spawn_id",
                table: "mission_scenario_step",
                columns: new[] { "mission_id", "content_revision", "spawn_group_id", "spawn_id" });

            migrationBuilder.CreateIndex(
                name: "IX_mission_scenario_step_mission_id_content_revision_target_objective_id",
                table: "mission_scenario_step",
                columns: new[] { "mission_id", "content_revision", "target_objective_id" });

            migrationBuilder.CreateIndex(
                name: "IX_mission_scenario_step_mission_id_content_revision_target_scenario_id",
                table: "mission_scenario_step",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_mission_trigger_mission_id_content_revision_related_objective_id",
                table: "mission_trigger",
