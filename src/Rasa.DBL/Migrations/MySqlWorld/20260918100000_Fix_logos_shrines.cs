...
namespace Rasa.Migrations.MySqlWorld
{
    ...
    public partial class Fix_logos_shrines : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql($"insert ignore into {Table} (id, class_id, map_context_id, pos_x, pos_y, pos_z, name) values (64, 21210, 1429, 40.0, 111.8014907836914, -224.0, 'Far');");
            migrationBuilder.Sql($"insert ignore into {Table} (id, class_id, map_context_id, pos_x, pos_y, pos_z, name) values (30, 12678, 1743, -30.0, 58.25, 18.75, 'Disperse');");
        }
