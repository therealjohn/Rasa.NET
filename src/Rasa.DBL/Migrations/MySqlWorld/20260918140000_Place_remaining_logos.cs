...
namespace Rasa.Migrations.MySqlWorld
{
    ...
    public partial class Place_remaining_logos : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.Sql($"insert ignore into {Table} (id, class_id, map_context_id, pos_x, pos_y, pos_z, name) values (180, 21228, 1454, -503.9174499511719, 233.5238037109375, -689.8259887695312, 'Good');");
            migrationBuilder.Sql($"insert ignore into {Table} (id, class_id, map_context_id, pos_x, pos_y, pos_z, name) values (106, 21146, 1743, -30.0, 58.25, 18.75, 'Civilization');");

            // The other mission stone, on the floor of the console overlook (approximate)
            migrationBuilder.Sql($"insert ignore into {Table} (id, class_id, map_context_id, pos_x, pos_y, pos_z, name) values (65, 21269, 1700, 608.0, 258.0, -30.0, 'Logos');");
        }
