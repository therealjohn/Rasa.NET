...
namespace Rasa.Migrations.MySqlChar
{
    ...
    public partial class ConsolidatedCharacterSchema : Migration
    {
        ...
        {
            // MySQL requires an indexed AUTO_INCREMENT column until identity is removed.
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    duration_hours = table.Column<uint>(type: "int unsigned", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    rewarded_at_utc = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    reward_window_start_utc = table.Column<DateTime>(type: "datetime(6)", nullable: true),
                    outcome = table.Column<uint>(type: "int unsigned", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    name = table.Column<string>(type: "varchar(64)", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    generation = table.Column<uint>(type: "int unsigned", nullable: false),
                    mission_id = table.Column<uint>(type: "int unsigned", nullable: true),
                    objective_id = table.Column<uint>(type: "int unsigned", nullable: true),
                    sequence_id = table.Column<uint>(type: "int unsigned", nullable: false, defaultValue: 0u),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    source_run_id = table.Column<string>(type: "varchar(32)", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    source_generation = table.Column<uint>(type: "int unsigned", nullable: true),
                    source_assignment_id = table.Column<string>(type: "varchar(32)", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    source_assignment_generation = table.Column<uint>(type: "int unsigned", nullable: true),
                    payload = table.Column<string>(type: "text", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    status = table.Column<string>(type: "varchar(16)", nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            // Restore each key before restoring its AUTO_INCREMENT column.
            migrationBuilder.AddPrimaryKey(
                name: "PK_ignored",
                table: "ignored",
                column: "account_id");
